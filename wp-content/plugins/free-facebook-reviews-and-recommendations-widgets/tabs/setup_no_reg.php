...
<span>1</span>
<?php echo TrustindexPlugin::___('Connect %s platform', [ 'Facebook' ]); ?>
</li>
...
{
$reviews = $wpdb->get_results('SELECT * FROM '. $trustindex_pm_facebook->get_noreg_tablename() .' ORDER BY date DESC');
}
?>
<?php if($current_step == 1 || !$trustindex_pm_facebook->is_noreg_linked()): ?>
<h1 class="ti-free-title">
1. <?php echo TrustindexPlugin::___('Connect %s platform', [ 'Facebook' ]); ?>
</h1>
...
<?php endif; ?>
<div class="ti-box">
<div class="ti-header"><?php echo TrustindexPlugin::___('See a %s Widget example below:', [ 'Facebook reviews and recommendations' ]); ?></div>
<div class="ti-preview-box">
<?php echo $trustindex_pm_facebook->get_trustindex_widget('a1e754a36568236614dccc191'); ?>
</div>
</div>
...
<div class="notice notice-warning" style="margin: 0 0 15px 0">
<p>
<?php echo TrustindexPlugin::___('There are no reviews on your %s platform.', [ 'Facebook' ]); ?>
</p>
</div>
<?php else: ?>
...
<div class="preview">
<?php echo $trustindex_pm_facebook->get_noreg_list_reviews(null, true, $id, 'light-background', true); ?>
</div>
</div>
</div>
<?php endforeach; ?>
...
<div class="preview">
<?php echo $trustindex_pm_facebook->get_noreg_list_reviews(null, true, $style_id, $id, true); ?>
</div>
</div>
</div>
<?php endforeach; ?>
...
<div class="preview">
<div id="ti-review-list"><?php echo $trustindex_pm_facebook->get_noreg_list_reviews(null, true); ?></div>
...
<a class="btn-text" href="https://www.trustindex.io/ti-redirect.php?a=sys&c=wp-facebook-1" target="_blank"><?php echo TrustindexPlugin::___('Create a Free Account for More Features'); ?></a>
...
<li>
<strong><?php echo TrustindexPlugin::___("%d Review Platforms", [ $trustindex_pm_facebook->get_platform_count() ]); ?></strong><br />
...
<a class="btn-text" href="https://www.trustindex.io/ti-redirect.php?a=sys&c=wp-facebook-2" target="_blank"><?php echo TrustindexPlugin::___('Create a Free Account for More Features'); ?></a>
</div>
<?php endif; ?>
<?php endif; ?>