...
{
update_option( $trustindex_pm_facebook->get_option_name('download-timestamp') , time() + (86400 * 2), false);
}
}
...
$wpdb->query("UPDATE `". $trustindex_pm_facebook->get_noreg_tablename() ."` SET highlight = '$highlight' WHERE id = '$id'");
}
exit;
}
$reviews = [];
...
<p><?php echo TrustindexPlugin::___("Connect your %s platform to download reviews.", ["Facebook"]); ?></p>
</div>
<?php else: ?>
...
<p>
<?php echo TrustindexPlugin::___("Don't want to waste your time by updating your reviews every week? <a href='%s' target='_blank'>Create a free Trustindex account! »</a>", [ 'https://www.trustindex.io/ti-redirect.php?a=sys&c=wp-facebook-l' ]); ?>
</p>
</div>
<?php endif; ?>
