...
<ul class="ti-check">
<li><?php echo TrustindexPlugin::___("%d Review Platforms", [ $trustindex_pm_facebook->get_platform_count() ]); ?></li>
...
<a class="btn-text btn-lg arrow-btn" href="https://www.trustindex.io/ti-redirect.php?a=sys&c=wp-facebook-3" target="_blank"><?php echo TrustindexPlugin::___('Create a Free Trustindex Account for More Features'); ?></a>
