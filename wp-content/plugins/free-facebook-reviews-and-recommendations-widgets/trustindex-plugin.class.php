...
$chosed_platform = new TrustindexPlugin($force_platform, $file_path, "do-not-care-7.1", "do-not-care-Widgets for Social Reviews & Recommendations", "do-not-care-Facebook");
