                ...
                <main id="main" class="site-main">
                    <div class="vc_row portfolio-grid <?php echo esc_attr( $grid_style_class . $grid_offset_class ); ?>" data-lazy-container="posts">
                        ...
                        while ( have_posts() ) : the_post();
                            ...
                            echo '<div class="portfolio-item-wrap masonry-block ohio-project-item grid-item section' . esc_attr( $col_class . $grid_class . $grid_offset_class ) . '" ' . esc_attr( $_anim_attrs ) . ' data-lazy-item="" data-lazy-scope="posts">';
