...
<nav id="site-navigation" class="main-nav<?php echo esc_attr( $site_navigation_class ); ?>" data-mobile-menu-second-click-link="<?php echo esc_attr( $mobile_second_click_link ); ?>">
        ...
        <div class="mbl-overlay-container">
            ...
            <div id="mega-menu-wrap" class="main-nav-container">
                ...
                <?php
                    ...
                    if ( $mobile_menu ) {
                        wp_nav_menu( [ 'menu' => $mobile_menu, 'menu_id' => 'mobile-menu', 'menu_class' => 'mobile-menu' ] );
                    }
                ?>
            </div>
