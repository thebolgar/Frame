...
$_selector = [
	...
	// '.dark-scheme .box-count',
	// '.dark-scheme .font-titles',
	// '.dark-scheme .fullscreen-nav .menu-link',
	// '.dark-scheme .clb-hamburger-nav .menu .nav-item a',
	// '.dark-scheme .site-header.mobile-header .main-nav .nav-item',
	// '.dark-scheme .btn, .dark-scheme .button, .dark-scheme a.button, .dark-scheme input[type="submit"], .dark-scheme a.btn-link',
	// '.dark-scheme .woo-c_product_name > a:not(.woo-c_product_category)',
	// '.dark-scheme .socialbar.inline a',
	// '.dark-scheme .vc_row .vc-bg-side-text',
