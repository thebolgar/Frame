...
if ( $border_visibility ) {
	...
	if ( $border_color ) {
		$border_css .= 'border-color:' . $border_color . ' !important;';
	}
}
...
if ( $fixed_border_visibility ) {
	...
	if ( $fixed_border_color ) {
		$fixed_border_css .= 'border-color:' . $fixed_border_color . ' !important;;';
	}
}
...
if ( $mobile_header_menu_color_css ) {
	$_selector = [
		...
		'.site-header:not(.header-fixed) .menu > li .sub-nav-item a',
		'.site-header:not(.header-fixed) .menu-optional .cart-total a',
...
if ( $header_height_css ) {
	$header_height_classes = '.site-header .header-wrap, .site-header.header-2 .header-wrap, .header-cap';
...
if ( $logo_height_css ) {
	$logo_height_classes = '.site-header .site-branding .logo img, .site-header .site-branding .mobile-logo img, .site-header .site-branding .fixed-mobile-logo img, .site-header .site-branding .for-onepage img';
