...
if ( $fullscreen_background_color_css ) {
	$_selector = [
		'.clb-hamburger-nav',
		'.clb-hamburger-nav.split div.sub-sub-nav:before',
		'.clb-hamburger-nav.split div.sub-nav:before',
	];
...
if ( $fullscreen_links_typo_css ) {
	$_selector = [
		...
		'.clb-hamburger-nav .menu .nav-item a .has-submenu-icon',
		'.clb-hamburger-nav .copyright a',
		'.clb-hamburger-nav .copyright'
	];
