                        ...
                        while ( have_posts() ) : the_post();
                            ...
                            switch ( $post->post_type ) {
                                ...
                                default: // default post or undefined custom
                                    ...
                                    echo '<div class="' . esc_attr( $col_class . $grid_class . ( ( $posts_grid == 'masonry' ) ? ' masonry-block blog-post-masonry' : '' ) ) . '" ' . esc_attr( $_anim_attrs ) . ' data-lazy-item="" data-lazy-scope="posts">';
